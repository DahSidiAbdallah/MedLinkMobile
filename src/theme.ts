export const colors = {
  primary:'#2563EB', primary600:'#1E40AF',
  accent:'#22C55E', warn:'#F59E0B', danger:'#EF4444',
  bg:'#F7FAFF', card:'#FFFFFF', text:'#0F172A', muted:'#6B7280', line:'#E5E7EB'
};
export const radius = { md:12, lg:16, xl:24, pill:999 };
export const spacing = { xs:6, sm:10, md:14, lg:18, xl:24, xxl:32 };
export const shadow = { card:{ elevation:6, shadowColor:'#000', shadowOpacity:0.08, shadowRadius:12, shadowOffset:{width:0,height:6} } };
export const type = {
