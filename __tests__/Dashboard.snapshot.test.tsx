...
jest.mock('../src/notifications/NotificationBell', () => () => React.createElement('span', null));
jest.mock('../src/notifications/NotificationsSheet', () => () => React.createElement('span', null));
